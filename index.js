...
module.exports = class DBLog {
  constructor(db) {
    this.db = db;
    this.logid; //must be undefined, null means id has been cleared due to error

    this.FIELDS = ["title", "msg", "props", "error", "status"];
    this.heartbeat;
    this.startCounter = 0;
  }

  async start(title, msg, props) {
